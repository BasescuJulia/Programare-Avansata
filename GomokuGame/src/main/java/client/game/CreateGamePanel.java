...
public class CreateGamePanel extends JPanel {
    ...
    public CreateGamePanel(final JFrame mainFrame) {
        ...
        createGameButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent ae) {
                ...
                if (StringUtils.isEmpty(userNameText)) {
                    ...
                    createGamePanelForPlayer(userNameText, gameNameText, mainFrame);
                }
    ...
    private void createGamePanelForPlayer(String userNameText, String gameNameText, JFrame mainFrame) {
